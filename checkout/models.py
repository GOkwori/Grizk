...
class Order(models.Model):
    ...
    order_reference = models.CharField(
        max_length=38, null=False, editable=False)
    ...
    street_address1 = models.CharField(
        max_length=80, null=False, blank=False)  # Corrected max_length
    street_address2 = models.CharField(
        max_length=80, null=True, blank=True)    # Corrected max_length
...
class OrderLineItem(models.Model):
    ...
    product_colour = models.CharField(
        max_length=20, null=True, blank=True)  # Corrected max_length
